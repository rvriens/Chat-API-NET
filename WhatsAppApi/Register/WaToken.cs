    ...
    class WaToken
    {
        public static string GenerateToken(string number, string platform)
        {
            ...
            if (platform == "Android")
            {
                ...
                byte[] classesMd5 = Convert.FromBase64String("PERSVxyRE03RRwC3TrED+g=="); // 2.12.291
                byte[] key2 = Convert.FromBase64String("/UIGKU1FVQa+ATM2A0za7G2KI9S/CwPYjgAbc67v7ep42eO/WeTLx1lb1cHwxpsEgF4+PmYpLd2YpGUdX/A2JQitsHzDwgcdBpUf7psX1BU=");
